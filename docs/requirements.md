...
> **Architecture Reference Document**: This comprehensive requirements document specifies the v2.0 architecture redesign. It is intended for architecture reference, development planning, and understanding system design decisions. For user-facing documentation, see [usage.md](usage.md) and [testing.md](testing.md).
